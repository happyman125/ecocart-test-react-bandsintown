...
const Hero: FunctionComponent<HeroProps> = ({
  ...
  if(!artist) return <div className="text-center">Artist not found!</div>
  const { name, imageUrl, thumbUrl, upcomingEventCount, facebookPageUrl, trackerCount  } = artist;
  return (
    <div
      style={{
        backgroundImage:
      ...
      className='hero-component flex items-center space-between'
    >
      <div className='hero__bg-overlay' />
      <div className='hero__details flex'>
        ...
        <div className='flex column justify-center'>
          <div className='hero__artist-name flex items-center'>
            <h1>{name}</h1>
            <svg
              className='hero__verified-badge'
              width='30px'
              height='18px'
              viewBox='0 0 67 71'
              version='1.1'
